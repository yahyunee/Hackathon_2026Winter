...
<div class="card">
  ...
  <ul>
    <li><strong>Multi-Lab Collaboration:</strong> 5 labs working together to break down silos</li>
    <li><strong>Real Outcomes:</strong> Trained models, validated hypotheses, and working prototypes</li>
    <li><strong>Expert Mentorship:</strong> GPU programming experts and domain specialists</li>
    <li><strong>Focused Environment:</strong> No emails, no admin work - just pure research</li>
  </ul>
</div>
...
<div class="card">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem; margin-top: 1rem;">
    <a href="{{ '/en/overview.html' | relative_url }}" class="btn">📖 Learn About Hackathons</a>
    <a href="{{ '/en/projects.html' | relative_url }}" class="btn">🔬 Research Projects</a>
    <a href="{{ '/en/tutorials.html' | relative_url }}" class="btn">📚 Preparation Guide</a>
  </div>
</div>
